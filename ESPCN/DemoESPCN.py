...
if __name__=='__main__':
    ...
    ScaleFactor=4
    epochs=200
    ESPCN=ESPCN.ESPCN(image_shape=(8,8,1),scale_factor=ScaleFactor)
    ESPCN_model=ESPCN.Build_ESPCN()
    ...
    history,test_loss,Model=ESPCN.Train_ESPCN(ESPCN_model,epochs,inputs_train,outputs_train,inputs_validation,outputs_validation,save_path_name)
    ...
    Predict_Patch=ESPCN_model.predict(TestData)
