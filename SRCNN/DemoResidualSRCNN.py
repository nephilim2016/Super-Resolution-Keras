...
if __name__=='__main__':
    ...
    ScaleFactor=4
    epochs=200
    ResidualSRCNN=SRCNN.ResidualSRCNN(image_shape=(32,32,1),scale_factor=ScaleFactor)
    ResidualSRCNN_model=ResidualSRCNN.Build_ResidualSRCNN()
    ...
    history,test_loss,Model=ResidualSRCNN.Train_ResidualSRCNN(ResidualSRCNN_model,epochs,inputs_train,outputs_train,inputs_validation,outputs_validation,save_path_name)
    ...
    Predict_Patch=ResidualSRCNN_model.predict(TestData)
